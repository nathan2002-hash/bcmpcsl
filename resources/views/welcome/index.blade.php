...
<div class="hero-wrap">
    <div class="home-slider owl-carousel">
      <div class="slider-item" style="background-image:url(images/log-1.jpg);">
          <div class="overlay"></div>
        <div class="container">
          <div class="row no-gutters slider-text align-items-center justify-content-end">
              <div class="col-md-6 ftco-animate">
                  <div class="text w-100">
                    <h1 class="mb-4">Welcome to Be Creative Multipurpose Co-operative Society LTD Web Page</h1>
                    <p>Empower Youths in the quest to reduce poverty and enhance a better living standard amongst themselves.</p>
                </div>
              </div>
            </div>
        </div>
        ...
        <div class="container">
          <div class="row no-gutters slider-text align-items-center justify-content-end">
              <div class="col-md-6 ftco-animate">
                  <div class="text w-100">
                    <h1 class="mb-4">Welcome to Be Creative Multipurpose Co-operative Society LTD Web Page</h1>
                    <p>Be-Creative Multi- Purpose Cooperative Society Limited shall not discriminate on the basis of race, color, religious affiliation, sex, age, ethnicity, or educational background.</p>
                </div>
              </div>
            </div>
            </div>
    ...
    <div class="container">
        <div class="row d-md-flex justify-content-center">
            <div class="col-md-12">
                    ...
                    <div class="col-md-12 bg-white text-center p-5">
                        <div class="desc border-bottom pb-4">
                            <h2>Business Hours</h2>
                      <div class="opening-hours">
                          <h4>Opening Days:</h4>
                          <p class="pl-3">
                              <span><strong>Monday – Friday:</strong> 7:00am to 17:00 pm</span>
                              <span><strong>Saturday :</strong> 7:00am to 14:00 pm</span>
                          </p>
                          <h4>Closing Days:</h4>
                          <p class="pl-3">
      ...
      <div class="col-md-6 services ftco-animate">
        <div class="d-block d-flex">
          <div class="media-body pl-3">
            <h3 class="heading">Mining</h3>
            <p>We deal in stone crushing, delivery of sand and gravel. In future we are planning to go into manganese and gold mining.</p>
          </div>
        </div>
        <div class="d-block d-flex">
          <div class="media-body pl-3">
            ...
            <div class="row no-gutters">
                <div class="col-md-4 col-lg ftco-animate d-flex">
                    <div class="staff bg-primary">
                        ...
                        <div class="text pt-3 px-3 pb-4 text-center">
                            <h3>Francis Mwamba</h3>
                            <span class="position mb-2">Chair Person</span>
                        </div>
                    </div>
                </div>
                <div class="col-md-4 col-lg ftco-animate d-flex">
                ...
                <div class="col-md-4 col-lg ftco-animate d-flex">
                    <div class="staff bg-primary">
                        ...
                        <div class="text pt-3 px-3 pb-4 text-center">
                            <h3>Jacob Chindumba</h3>
                            <span class="position mb-2">Construction Manager</span>
                           </div>
                        </div>
                    </div>
                    </div>
    ...
    <section class="ftco-section ftco-no-pt ftco-no-pb">
        ...
        <div class="work img d-flex align-items-center" style="background-image: url(images/work-1.jpg);">
            ...
            <div class="desc w-100 px-4 text-center pt-5 mt-5">
              <div class="text w-100 mb-3 mt-4">
                  <h2><a href="work-single.html">Wheel Barrows</a></h2>
              </div>
          </div>
        </div>
      </div>
      <div class="col-md-3 ftco-animate">
        <div class="work img d-flex align-items-center" style="background-image: url(images/work-2.jpg);">
            ...
            <div class="desc w-100 px-4 text-center pt-5 mt-5">
              <div class="text w-100 mb-3 mt-4">
                  <h2><a href="work-single.html">Tomatoes</a></h2>
              </div>
          </div>
        </div>
      </div>
      <div class="col-md-3 ftco-animate">
        <div class="work img d-flex align-items-center" style="background-image: url(images/work-3.jpg);">
            ...
            <div class="desc w-100 px-4 text-center pt-5 mt-5">
              <div class="text w-100 mb-3 mt-4">
                  <h2><a href="work-single.html">Chickens</a></h2>
              </div>
          </div>
        </div>
      </div>
      <div class="col-md-3 ftco-animate">
        <div class="work img d-flex align-items-center" style="background-image: url(images/work-4.jpg);">
            ...
            <div class="desc w-100 px-4 text-center pt-5 mt-5">
              <div class="text w-100 mb-3 mt-4">
                  <h2><a href="work-single.html">Peanut Butter</a></h2>
              </div>
          </div>
        </div>
      </div>
      ...
      <div class="col-md-3 ftco-animate">
        <div class="work img d-flex align-items-center" style="background-image: url(images/work-5.jpg);">
            ...
            <div class="desc w-100 px-4 text-center pt-5 mt-5">
              <div class="text w-100 mb-3 mt-4">
                  <h2><a href="work-single.html">Pigs</a></h2>
              </div>
          </div>
        </div>
      </div>
      <div class="col-md-3 ftco-animate">
        <div class="work img d-flex align-items-center" style="background-image: url(images/work-6.jpg);">
            ...
            <div class="desc w-100 px-4 text-center pt-5 mt-5">
              <div class="text w-100 mb-3 mt-4">
                  <h2><a href="work-single.html">Fish</a></h2>
              </div>
          </div>
        </div>
      </div>
      <div class="col-md-3 ftco-animate">
        <div class="work img d-flex align-items-center" style="background-image: url(images/work-7.jpg);">
            ...
            <div class="desc w-100 px-4 text-center pt-5 mt-5">
              <div class="text w-100 mb-3 mt-4">
                  <h2><a href="work-single.html">Onion</a></h2>
              </div>
          </div>
        </div>
      </div>
        ...
        <div class="blog-entry align-self-stretch">
          ...
          <div class="text mt-3">
              <div class="posted mb-3 d-flex">
                  ...
                  <div class="desc pl-3">
                      <span>Posted by Francis Mwamba</span>
        ...
        <div class="blog-entry align-self-stretch">
          ...
          <div class="text mt-3">
              <div class="posted mb-3 d-flex">
                  ...
                  <div class="desc pl-3">
                      <span>Posted by Deborah Mwamba</span>
        ...
        <div class="blog-entry align-self-stretch">
          ...
          <div class="text mt-3">
              <div class="posted mb-3 d-flex">
                  ...
                  <div class="desc pl-3">
                      <span>Posted by Priscillah Mwamba</span>
